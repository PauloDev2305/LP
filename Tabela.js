...
class Tabela {
    constructor() {
        this.listaDeGrupos = new Array();
        this._iniciado = false; // Criando o atributo iniciar para ter o controle de não permitir que o programa seja iniciado mais de uma vez!
    }
    set lista_Grupos(listaDeGrupos) {
    ...
    criarGrupos() {
        this.listaDeGrupos["A"] = new Grupo_1.Grupo("A");
        this.listaDeGrupos["B"] = new Grupo_1.Grupo("B");
        this.listaDeGrupos["C"] = new Grupo_1.Grupo("C");
        this.listaDeGrupos["D"] = new Grupo_1.Grupo("D");
        this.listaDeGrupos["E"] = new Grupo_1.Grupo("E");
        this.listaDeGrupos["F"] = new Grupo_1.Grupo("F");
        this.listaDeGrupos["G"] = new Grupo_1.Grupo("G");
        this.listaDeGrupos["H"] = new Grupo_1.Grupo("H");
    }
    // Iniciando a tabela
    iniciar() {
